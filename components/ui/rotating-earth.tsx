...
export default function RotatingEarth({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      context.fill()
      context.strokeStyle = "rgba(201, 168, 76, 0.3)"
      ...
      if (landFeatures) {
        ...
        context.strokeStyle = "rgba(201, 168, 76, 0.25)"
        ...
        allDots.forEach((dot) => {
          ...
          if (
            ...
            context.fillStyle = "rgba(201, 168, 76, 0.35)"
            context.fill()
          }
        })
        ...
        visibleMarkers.forEach((vm, i) => {
          ...
          context.fillStyle = "rgba(201, 168, 76, 0.15)"
          context.fill()

          // Inner glow
          context.beginPath()
          context.arc(px, py, 5 * scaleFactor, 0, 2 * Math.PI)
          context.fillStyle = "rgba(201, 168, 76, 0.3)"
          context.fill()
          ...
          context.fillStyle = "rgba(201, 168, 76, 0.5)"
          context.fill()
