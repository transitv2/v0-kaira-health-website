                ...
                {cityData.clinics && cityData.clinics.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {cityData.clinics.map((clinic) => (
                      <div
                        key={clinic.name}
                        className="rounded-xl border border-[#2A2A2A] bg-dark-surface p-6 transition-all duration-300 hover:border-gold/20"
                      >
                  ...
                  /* Coming soon city */
                  <div className="rounded-xl border border-dashed border-[#2A2A2A] bg-dark-surface/50 p-8 text-center">
